...
The full content of the output generated by the tool IS your final response. Remember to respond with a markdown code snippet of a json blob with a single action, and NOTHING else."""
