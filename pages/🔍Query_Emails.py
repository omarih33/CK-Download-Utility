...
Please include the full content of the output generated by the tool in your response. Remember to respond with a markdown code snippet of a json blob with a single action, and NOTHING else."""
